<template>
    <div class="upload">
        <el-form :rules="rules" label-width='95px' ref="articleForm" :model="articleForm">
            ...
            <el-form-item label="文章分类：" prop='kind1'>
                <el-select v-model="articleForm.kind1" placeholder="请选择" @change=selectOne>
                    <el-option
            ...
            <el-form-item prop='kind2'>
                <el-select v-model="articleForm.kind2" placeholder="请选择">
                    <el-option
            ...
            <div class="upload_model">
                ...
                <el-upload class="avatar-uploader"
                           ref="upload"
                           action="https://www.zhhtjy.cn:1242/article/upload"
                           :auto-upload="false"
            ...
            <div class="upload_model">
                ...
                <x-editor style="width:800px;min-height:400px" v-model="articleForm.content"></x-editor>
            </div>
...
<script>
    import xEditor from '../components/wangeditor.vue';
	export default {
		components:{
			XEditor:xEditor
        },
        ...
        data(){
            return{
                ...
                rules:{
                    ...
                    kind1: [
                        { required: true, message: '请选择一级文章分类', trigger: 'change' }
                    ],
                    kind2:[
                        { required: true, message: '请选择二级文章分类', trigger: 'change' }
                    ],
                    intro:[
        ...
        methods: {
            selectOne (params) {
                // console.log(params)
                this.articleForm.kind1 = params.value;
                // console.log(this.articleForm.kind1)
                this.articleForm.kind2 = ' ';
